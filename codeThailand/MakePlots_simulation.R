...
load(paste("Incidence",senario,"/", country, region,".RData",sep=""))
...
# if (senario=="F3" | senario=="G3")		optimizer$hessian = diag(1,2)*10^20
...
jpeg(file=paste("JPG/", senario, "/", country, region, "Senario", senario, ".jpg", sep=""), width = 900, height = 400, pointsize = 12, quality = 75)
